...
export const OPPORTUNITIES_SYSTEM_FIELDS: SystemFieldDefinition[] = [
  ...
  {
    id: 'system-forecastCategory',
    fieldKey: 'forecastCategory',
  ...
  {
    id: 'system-weightedAmount',
    fieldKey: 'weightedAmount',
    fieldLabel: 'Weighted Amount',
    fieldType: 'number',
    section: 'basic',
    isRequired: false,
    columnSpan: 1,
    displayOrder: 13,
    isSystem: true,
    isEditable: false, // Computed field (amount × probability / 100)
  },
  ...
  {
    id: 'system-competitor',
    fieldKey: 'competitor',
    fieldLabel: 'Competitor',
    fieldType: 'text',
    section: 'other',
    isRequired: false,
    placeholder: 'Primary competitor',
    columnSpan: 1,
    displayOrder: 42,
    isSystem: true,
    isEditable: true,
