...
import {
  ...
  Sun, Snowflake, Minus, Timer, Clock, ArrowUpCircle, Users
} from 'lucide-react';
    ...
    <div className="animate-fadeIn">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Lead Settings</h1>
...
function StageOwnershipTab({
  stages, pipelines, selectedPipelineId, module, onPipelineChange,
}: {
  stages: LeadStage[];
  pipelines: Pipeline[];
  selectedPipelineId: string;
  ...
  // Load ownership data for all stages in one bulk call
  useEffect(() => {
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400">
            Configure who owns each stage — when a {module === 'leads' ? 'lead' : 'opportunity'} moves to a stage, ownership can change automatically
          </p>
        </div>
      </div>
              ...
              return (
                <div key={stage.id}>
                  ...
                  >
                    ...
                    {/* Owner type badge */}
                    <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${OWNER_TYPE_COLORS[ownerType] || OWNER_TYPE_COLORS.inherit}`}>
