...
export const DATA_SOURCES: Record<string, DataSourceDefinition> = {
  ...
  tasks: {
    ...
    fields: [
      ...
      { key: 'entity_type', label: 'Related Module', type: 'text', sqlExpr: 't.entity_type', groupable: true, filterable: true },
      // Joined
      { key: 'owner_name', label: 'Owner', type: 'text', sqlExpr: "CONCAT(u.first_name, ' ', u.last_name)", join: 'users', groupable: true, filterable: true },
      { key: 'owner_id', label: 'Owner ID', type: 'text', sqlExpr: 't.assigned_to', filterable: true },
