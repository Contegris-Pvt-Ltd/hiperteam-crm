...
IntelliSales CRM uses a **schema-per-tenant** isolation model. Every tenant gets a dedicated PostgreSQL schema containing all their tables, data, and configurations.
