...
description: "Complete reference of all environment variables used by the IntelliSales CRM backend and frontend"
---
...
| `SMTP_FROM_NAME` | No | `IntelliSales CRM` | Default "From" display name |
...
SMTP_FROM_NAME=IntelliSales CRM
SMTP_SECURE=false
```
...
| `VITE_APP_NAME` | No | `IntelliSales CRM` | Application display name |
| `VITE_VAPID_PUBLIC_KEY` | No | — | VAPID public key for push subscriptions |

```env
VITE_API_URL=http://localhost:3000
VITE_APP_NAME=IntelliSales CRM
