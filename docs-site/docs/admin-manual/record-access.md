...
description: "Configure record-level access scoping in Intellicon CRM — control which records users can see based on ownership, teams, departments, and reporting lines."
---
