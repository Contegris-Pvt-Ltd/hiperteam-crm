...
sidebar_position: 33
title: "Batch Jobs"
description: "Monitor and manage batch import and export jobs in Intellicon CRM — track progress, view errors, download failed records, and manage job history."
---
...
All long-running operations in Intellicon CRM are processed as background jobs using a queue system. This allows users to continue working while operations complete.
