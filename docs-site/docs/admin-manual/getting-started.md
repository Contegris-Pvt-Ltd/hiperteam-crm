...
description: "Welcome to the Intellicon CRM Admin Manual — learn who this guide is for, what admin access means, and how to navigate the admin panel."
---
...
1. Log in to Intellicon CRM with your admin credentials.
