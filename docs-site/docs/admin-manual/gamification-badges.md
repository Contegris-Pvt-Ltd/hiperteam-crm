...
description: "Configure gamification in IntelliSales CRM — create badges, achievements, leaderboards, and incentive programs to motivate your team."
---

# Gamification & Badges

Gamification adds a motivational layer to IntelliSales CRM by rewarding users with badges and achievements for hitting milestones, and ranking performance on leaderboards.
