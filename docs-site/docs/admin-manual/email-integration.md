...
description: "Configure email integration in IntelliSales CRM — connect Gmail and Outlook, set up SMTP for outbound, configure signatures, sync settings, and auto-link rules."
---

# Email Integration

Email integration connects your team's email accounts to IntelliSales CRM, enabling email tracking, automatic association with CRM records, and centralized communication history.
