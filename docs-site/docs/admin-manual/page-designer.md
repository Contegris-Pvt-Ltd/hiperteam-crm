...
description: "Use the Layout Designer in IntelliSales CRM to control field layout, section grouping, and form structure on record detail pages with drag-and-drop."
---
