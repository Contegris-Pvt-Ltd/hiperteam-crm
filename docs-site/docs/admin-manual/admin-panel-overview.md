...
description: "Navigate the Intellicon CRM admin panel — understand the sidebar structure, find settings quickly, and follow the recommended setup sequence."
---

# Admin Panel Overview

The Admin Panel is your central command center for configuring every aspect of Intellicon CRM. This chapter provides a map of the interface so you can find any setting quickly.
...
When setting up a new Intellicon CRM instance, follow this order to avoid dependency issues:
