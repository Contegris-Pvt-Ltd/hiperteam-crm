...
description: "Customize notification message templates in Intellicon CRM — use template variables, edit email/SMS/in-app templates, preview, and test delivery."
---
