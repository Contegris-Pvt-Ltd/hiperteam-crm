...
sidebar_position: 20
title: "Task Settings"
description: "Configure task types, statuses, and priorities in IntelliSales CRM — customize icons, colors, ordering, and default values for the task management module."
---
