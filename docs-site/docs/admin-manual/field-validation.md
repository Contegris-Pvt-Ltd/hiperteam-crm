...
description: "Configure field validation rules in IntelliSales CRM — enforce required fields, format constraints, value ranges, regex patterns, and conditional visibility."
---
