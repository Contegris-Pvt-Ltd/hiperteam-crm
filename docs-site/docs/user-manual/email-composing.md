...
description: "Compose, reply, and forward emails from within IntelliSales CRM with rich text editing, attachments, signatures, and entity linking."
---

# Composing Emails

The integrated inbox lets you compose, reply to, and forward emails without leaving IntelliSales CRM. All sent emails are automatically tracked and can be linked to CRM records.
