...
description: "Understand the IntelliSales CRM dashboard, manage tabs, apply filters, and share dashboards with your team."
---

# Dashboard Overview

The Dashboard is your home screen in IntelliSales CRM. It provides a real-time, at-a-glance view of your key metrics, pipeline health, team performance, and upcoming activities — all in customizable, widget-based layouts.
...
IntelliSales CRM supports **multiple dashboard tabs**, allowing you to create separate dashboards for different purposes.
